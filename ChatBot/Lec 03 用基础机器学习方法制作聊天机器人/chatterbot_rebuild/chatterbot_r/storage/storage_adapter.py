...
class StorageAdapter(object):
    ...
    that all storage adpaters should implement.
    '''

    def __init__(self, base_query=None, *args, **kwargs):
        '''
        Initalize common attributes shared by all storage adapters.
        '''
        self.kwargs = kwargs
        self.logger = kwargs.get('logger', logging.getLogger(__name__))
        self.adapter_supoorts_queries = True
    ...
    def get_model(self, model_name):
        ...
        kwargs_model_key = '%s_model' % (model_name, )

        if kwargs_model_key in self.kwargs:
            return self.kwargs.get(kwargs_model_key)
    ...
    def remove(self, statement_text):
        ...
        '''
        raise self.AdapterMethodNotImplementedError(
            'The "move" method is not implementd by this adapter.'
        )

    def filter(self, **kwargs):
        '''
        Returns a list of objects from the database.
        The kwargs parameter can contain any number of attributes.
        Only objects which contain all listed attributes and in which all values
        match for all listed attributeds will be returned.
        '''
        raise self.AdapterMethodNotImplementedError(
    ...
    def create(self, **kwargs):
        ...
        '''
        raise self.AdapterMethodNotImplementError(
    ...
    def get_random(self):
        '''
        Returns a random statemtn from the database.
        '''
        raise self.AdapterMethodNotImplementedError(
    ...
    def get_response_statements(self):
        ...
        in the in_reponse_to filed.
        Otherwise, the logic adapter may find a closest matching statement that
        does not have a known reponse.
    ...
    class AdapterMethodNotImplementedError(NotImplementedError):
        '''
        An exception to be raised when a storage adapter method has
        not been implemented.

        Typically this indicates that the method shold be implement
        in a subclass.
        '''
        pass
